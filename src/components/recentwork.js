  ...
  if(index===0){
    ...
    return(
        ...
        <div className="recentwork">
            ...
            <div className='test'>   
  <div  className={index===0?'activeslide':index-10===0?'nextslide':index-9===0?'nextnextslide':'none'}>
    <img src='https://themezaa.b-cdn.net/wp-content/uploads/2022/04/litho.jpg' width='400'/>  </div>
<div className={index===1?'activeslide':index+1===1?'nextslide':index-10===0?'nextnextslide':'none'} > <img src='https://themezaa.b-cdn.net/wp-content/uploads/2019/12/hongo.jpg' width='400'/>  </div>
